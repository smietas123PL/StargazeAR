...
Agents run externally and report into the control plane. In the lite build, the built-in local path is Gemini CLI, while shell and HTTP-based runtimes can still call the API.
